...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaLogs/releases/download/v1.24.0-victorialogs/vlutils-linux-amd64-v1.25.0.tar.gz
tar xzf vlutils-linux-amd64-v1.25.0.tar.gz
./vlogscli-prod
```
